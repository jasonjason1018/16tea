        ...
        <div class="step">
            <div class="step-item -active" data-step="intro">
                <div class="intro">
                    ...
                    <button class="intro-btn" data-step-btn="task"  onclick="atag('click','sunrise page','enter s')"></button>
                </div>
            </div>
                    ...
                    <div class="card-wrap">
                        <div class="task">
                            ...
                            <div class="task-action">
                                <button class="btn" data-step-btn="instruction" onclick="atag('click','sunrise page','go')">開始挑戰</button>
                            </div>
                        </div>
                    </div>
                </div>
